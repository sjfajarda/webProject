...
foreach ($buffets as $buffet) {
    ...
    if ($restoName == $id) {
        ...
        $newNode->appendChild($rLocation);
        $newNode->appendChild($rPrice);
        $newNode->appendChild($rService);
        $newNode->appendChild($rOHours);
        $newNode->appendChild($xml->createTextNode("\n"));
        $newNode->appendChild($rLogo);
        $newNode->appendChild($rCHours);
        $newNode->appendChild($rRating);
        $newNode->appendChild($xml->createTextNode("\n"));
        $newNode->appendChild($rPic);
        $newNode->appendChild($xml->createTextNode("\n"));
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Restaurant Information Successfully Updated!</p>
                    </div>
