...
<body id="top" onload="openView()">
    ...
    <header class="header" data-header>
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                ...
                <a href="#" class="logo">
                    <img src="./assets/images/logo.svg" width="160" height="50" alt="Luxe Buffet PH">
                </a>
    ...
    <main>
        <article>
            ...
            <section class="section service bg-black-10 text-center" aria-label="service" id="view-screen">
                <div class="container">
                    ...
                    <ul class="grid-list">
                        ...
                        $search = strtolower($_POST["iSearch"]);
            ...
            <section class="section about text-center" aria-labelledby="about-label" id="add-screen" style="display: none;">
                ...
                <div class="container2" id="univ-form">
                    ...
                    <form action="addProcess.php" method="POST" id="add-form" onsubmit="validateForm(event)">
                        ...
                        <div class="input-name">
                            ...
                            <input type="text" name="resto-name" id="resto-name" placeholder="Enter Restaurant Name" required>
                        ...
                        <ul class="grid-list">
                            ...
                            foreach ($buffets as $buffet) {
                                ...
                                if ($search == $name) {
                                    ...
                                    echo "<button class='btn-text hover-underline label-2' id='btnDelete' data-toggle='modal' data-target='#exampleModalCenter' data-value = '$restaurantName'>Delete</button>";
                                    echo "</div>";
                                    echo "</div>";
                                    echo "</li>";
                                }
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure do you want to delete this restaurant?
                    <?php echo $Search; ?>
                </div>
